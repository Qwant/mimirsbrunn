    ...
    fn from(value: TaggedPart) -> Self {
        TaggedPartLegacy {
            tag: match value.tag {
                ...
                Tag::City => "location",
                Tag::State => "location",
                Tag::District => "location",
                Tag::CityDistrict => "location",
                Tag::Suburb => "location",
                Tag::Country => "location",
                Tag::Address => "address",
                Tag::Street => "street",
...
impl From<Tag> for TagDto {
    fn from(value: Tag) -> Self {
        match value {
            ...
            Tag::Country => TagDto::Country,
            Tag::State => TagDto::State,
            Tag::CityDistrict => TagDto::CityDistrict,
            Tag::Suburb => TagDto::Suburb,
            Tag::District => TagDto::District,
