use runtime::logger::{logger_init, Error as LoggerError};
...
use crate::prometheus_handler::update_metrics;
use crate::routes;
use elastic_client::remote::{connection_pool_url, Remote, RemoteError};
...
pub fn run(opts: &Opts) -> Result<(), Error> {
    ...
    let runtime = tokio_runtime::Builder::new_multi_thread()
